    ...
    return (
        <div className="flex flex-col lg:flex-row mt-10 lg:mt-0 lg:w-5/6 mx-auto">
            <div className="lg:relative lg:border-r lg:border-slate-300 flex flex-col gap-y-10">
                ...
                <div className="hidden lg:block w-[200px] h-[500px] bg-primary absolute filter opacity-15 top-[100px] rotate-45 -right-[300px] blur-3xl"></div>
                ...
                <div className="flex flex-col lg:flex-row lg:absolute lg:top-[200px] items-center lg:left-24 lg:-z-10">
