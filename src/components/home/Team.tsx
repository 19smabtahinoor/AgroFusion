    ...
    <div className="bg-[#f3fff5] border-b-2 border-primary mt-[40px] mb-[200px]">
      <div className="container pt-[100px]">
        <div className="text-center mb-20">
          ...
          <p>
            Get to know the passionate team driving innovation and supporting
            sustainable farming
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-y-[100px]">
          {teamData.map(({ name, image, designation }) => (
            <div
              key={name}
            ...
            >
              ...
              />
              <div className="text-center absolute -bottom-20 md:-bottom-24 lg:-bottom-24">
